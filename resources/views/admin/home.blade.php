        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('sentemail') }}" onclick="confirmation(event)">Sent Email</a></li>
              @foreach ($user as $data)
              <li class="breadcrumb-item active"><a href="{{ route('sent',$data->email) }}">{{ $data->name }}</a></li>
              @endforeach
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
