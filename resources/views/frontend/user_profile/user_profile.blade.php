    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="account-card mb-0">
                    ...
                    <div class="account-content">
                        <div class="row">
                            <div class="col-md-6 col-lg-4 alert fade show">
                                <div class="payment-card payment active"><img src="{{ asset('/') }}frontend/images/payment/png/01.png" alt="payment">
                                    <h4>card number</h4>
                            ...
                            <div class="col-md-6 col-lg-4 alert fade show">
                                <div class="payment-card payment"><img src="{{ asset('/') }}frontend/images/payment/png/02.png" alt="payment">
                                    <h4>card number</h4>
                                    <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                    <h5>miron mahmud</h5>
                                    <button class="trash icofont-ui-delete" title="Remove This" data-bs-dismiss="alert"></button>
                            ...
                            <div class="col-md-6 col-lg-4 alert fade show">
                                <div class="payment-card payment"><img src="{{ asset('/') }}frontend/images/payment/png/03.png" alt="payment">
                                    <h4>card number</h4>
                                    <p><span>****</span><span>****</span><span>****</span><sup>1876</sup></p>
                                    <h5>miron mahmud</h5>
                                    <button class="trash icofont-ui-delete" title="Remove This" data-bs-dismiss="alert"></button>
            ...
            <div class="col-lg-12">
                <div class="account-card mb-0">
                    <div class="account-title">
                        <h4 class="text-war">Safely Logout</h4>
